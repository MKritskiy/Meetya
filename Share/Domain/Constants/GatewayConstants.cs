...
{
    public const string GATEWAY_EXTERNAL_HOST = "http://localhost:50000";
    public const string GATEWAY_INTERNAL_HOST = "http://yarp.gateway:8080";
    public const string MESSAGE_API_ROUTE = "/messages-api/";
